    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.TextField(verbose_name='Hospital Registration Code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.TextField()),
                ('marital', models.CharField(choices=[('M', 'Married'), ('S', 'Single'), ('D', 'Divorced')], max_length=1, verbose_name='Marital Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True, verbose_name='Date of report')),
                ('diagnosis', models.TextField()),
                ('prescription', models.TextField()),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='GHEMSApp.Patient')),
            ],
        ),
    ]
